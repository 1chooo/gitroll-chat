    ...
    background: (
      <div className="absolute inset-0 overflow-hidden">
        <Marquee className="[--duration:25s] absolute top-4">
          <div className="bg-neutral-800/50 rounded-lg p-4 border border-neutral-700 mr-4 min-w-[280px] min-h-[175px]">
            <div className="text-white font-semibold text-sm">Maria Santos</div>
          ...
          <div className="bg-neutral-800/50 rounded-lg p-4 border border-neutral-700 mr-4 min-w-[280px] min-h-[175px]">
            ...
            <div className="text-neutral-400 text-xs">Ex-Founder • Mentor</div>
            <div className="text-purple-300 text-xs mt-2">
              ✓ Brazil logistics expert
            </div>
            <div className="text-yellow-300 text-xs">✓ Startup accelerator</div>
          </div>
          <div className="bg-neutral-800/50 rounded-lg p-4 border border-neutral-700 mr-4 min-w-[280px] min-h-[175px]">
            <div className="text-white font-semibold text-sm">Carla Lima</div>
            <div className="text-neutral-400 text-xs">
            ...
            <div className="text-blue-300 text-xs">✓ 8 mutual connections</div>
          </div>
          <div className="bg-neutral-800/50 rounded-lg p-4 border border-neutral-700 mr-4 min-w-[280px] min-h-[175px]">
            <div className="text-white font-semibold text-sm">Daniel Kwon</div>
            <div className="text-neutral-400 text-xs">
      ...
      <div className="max-w-6xl mx-auto">
        <BlurFade delay={0.2} inView>
          <div className="flex flex-col items-center text-center mb-16 space-y-4">
            <h2
              id="features"
              className="scroll-mt-32 max-w-2xl text-3xl text-center sm:text-4xl font-semibold bg-gradient-to-br from-white to-neutral-400 bg-clip-text text-transparent"
            >
